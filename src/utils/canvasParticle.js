function CanvasParticle(Dom,options){
    options = options || {}
    this.Element = Dom
...
CanvasParticle.prototype.Run = function(){
    if( this.clicked ){
...
CanvasParticle.prototype.getLength=function(){
    let arr = []
...
CanvasParticle.prototype.Draw = function(list){
    let new_arr = []
    let line_arr = []
...
CanvasParticle.prototype.drawLine = function(list){
    list.map( (item)=>{
        this.Dom.beginPath()
...
CanvasParticle.prototype.ControlXY = function(obj){
...
CanvasParticle.prototype.ControlRound = function(obj){
    switch(obj.controlX){
        case "right":
            obj.x++;
            break;
...
CanvasParticle.prototype.Clicked = function(event){
    let obj = {}
        obj.x = event.clientX
        obj.y = event.clientY
        obj.r = parseInt( Math.random()*10 )
...
CanvasParticle.prototype.moveXY = function(event){
    let obj = {}
        obj.x = event.clientX
        obj.y = event.clientY
        obj.r = 0
...
CanvasParticle.prototype.moveoutXY = function(event){
    this.list.shift()
}
CanvasParticle.prototype.pause = function(){
...
// var a = new CanvasParticle(root,{length:50,clicked:true,moveon:true})
//     a.Run()
